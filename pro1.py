...
for prefix in l:
	for i in range(8,11):
		path = '/home/limat/ADFA-LD/ADFA-LD/Attack_Data_Master/' + prefix + '_' + str(i) + '/*.txt'#the directories we are working with
...
path = '/home/limat/ADFA-LD/ADFA-LD/Validation_Data_Master/*.txt'
files = sorted(glob.glob(path))
